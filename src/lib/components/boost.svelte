...
<div id="boost">
	<section
		class="relative mt-10 bg-primary-bg bg-[url('/images/bg-boost-mobile.svg')] md:bg-[url('/images/bg-boost-desktop.svg')] bg-right-top md:bg-left-top bg-no-repeat md:bg-cover"
	>
		<!-- <img
